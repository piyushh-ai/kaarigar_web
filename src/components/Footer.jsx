  ...
  return (
    <section className="bg-gradient-to-t from-gray-900 via-gray-800 to-gray-900 border-t border-gray-700">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2 text-center sm:text-left">
            ...
            <p className="text-gray-300 leading-relaxed mb-6 max-w-md mx-auto sm:mx-0">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
              <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2 justify-center sm:justify-start">
              ...
              <div className="mt-4 p-3 bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-lg border border-emerald-500/20 text-center sm:text-left">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2 justify-center sm:justify-start">
            ...
            <div className="space-y-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`flex items-center justify-center sm:justify-start gap-3 text-gray-400 ${social.color} transition-all duration-300 hover:translate-x-1 group`}
                >
      ...
      <div className="border-t border-gray-700/50 bg-gray-900/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
          <div className="text-gray-400 text-sm">
            &copy; {currentYear} Kaarigar Code. Made with{" "}
            <span className="text-red-500 animate-pulse">❤️</span> in India
          </div>

          <div className="flex flex-wrap justify-center sm:justify-end items-center gap-4 text-sm text-gray-400">
            <Link
              href="/privacy"
      ...
      <button
        ...
        className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white p-3 rounded-full shadow-2xl hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-110 z-50"
