        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              Simulate your GPS location anywhere in the world for development and testing purposes. 
              Perfect for location-based app development, testing geofencing, and debugging GPS features.
            </p>
      ...
      <div className="bg-gray-800/30 backdrop-blur-sm py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">See TeleportGo in action</p>
          </div>
      ...
      <div className="bg-gray-900/50 backdrop-blur-sm py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">Everything you need for location-based development</p>
          </div>
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-6">
            <a href="https://www.youtube.com/@KaarigarCode" className="flex items-center gap-2 bg-red-600 hover:bg-red-700 px-6 py-3 rounded-xl transition-colors">
              📺 YouTube
            </a>
            <a href="https://github.com/piyushh-ai" className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 px-6 py-3 rounded-xl transition-colors">
              🐙 GitHub
            </a>
          </div>
        </div>
